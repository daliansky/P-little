...
DefinitionBlock ("", "SSDT", 2, "hack", "BATT", 0)
{
    ...
    External(_SB.PCI0.LPCB.EC0.AC._PSR, MethodObj)
    External(_SB.PCI0.LPCB.EC0.BSWR, IntObj)
    External(_SB.PCI0.LPCB.EC0.BSWA, IntObj)
    ...
    Scope(\_SB.PCI0.LPCB.EC0)
    {
        ...
        Method (GBST, 4, NotSerialized)
        {
            ...
            Else
            {
                If (\_SB.PCI0.LPCB.EC0.AC._PSR ())
                {
                    If (LEqual (Arg0, 0x00))
                    {
                        Store (X0I0, Index (Arg3, 0x00))
                        Store (X0I1, Index (Arg3, 0x01))
                        Store (X0I2, Index (Arg3, 0x02))
                        Store (X0I3, Index (Arg3, 0x03))
                    }
                    Else
                    {
                        Store (X1I0, Index (Arg3, 0x00))
                        Store (X1I1, Index (Arg3, 0x01))
